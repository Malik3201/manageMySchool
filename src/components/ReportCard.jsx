...
const ReportCard = ({ report }) => {
  ...
  // Assuming only 1 student report per search
  const student = report[0];

  return (
    <div className="max-w-4xl mx-auto bg-gradient-to-b from-white to-gray-50 shadow-xl rounded-2xl p-8 mt-8 border border-gray-200">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b pb-5 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">{student.exam}</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 text-center">
        ...
        <div className="bg-gray-50 p-4 rounded-lg shadow-sm border">
          ...
          <p className="text-xl font-bold text-purple-600">{student.grade}</p>
        </div>
      </div>
