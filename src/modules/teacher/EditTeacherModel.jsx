...
import { getClassSectionCombinations } from "../../utils/classUtils";
...
function EditTeacherModel({ isOpen, onClose, teacher }) {
  ...
  useEffect(() => {
    if (teacher && isOpen) {
      ...
      const teacherClasses = Array.isArray(teacher.assignedClasses) ? teacher.assignedClasses : [];
      ...
      setValue('assignedClasses', teacherClasses);
      setValue('subjects', teacherSubjects);
    }
  }, [teacher, isOpen, reset, setValue]);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-red-100 text-sm">Update teacher information</p>
              </div>
            </div>
            <button
              onClick={onClose}
